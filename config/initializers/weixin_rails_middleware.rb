...
WeixinRailsMiddleware.configure do |config|
  ...
  config.weixin_token_string = 'ef375b191c1849c88d065199'
  # using to weixin server url to validate the token can be trusted.
  config.weixin_secret_string = 'ji6lKbWoB3EltQ_iTxlWZE4XPrLwWtY-'
  # 加密配置，如果需要加密，配置以下参数
  # config.encoding_aes_key = 'd70d9d6adf21be5b1ecf7b57367c548bc1a055e2af0'
